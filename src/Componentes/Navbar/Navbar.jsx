    ...
    <div>
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a
            href="/"
            className="flex items-center justify-center space-x-3 rtl:space-x-reverse w-full sm:w-auto"
          >
            <img
              src={icon}
              className="h-[100px] w-30 sm:h-[150px] sm:w-21"
              alt="PCBarata Logo"
            />
          </a>
          {/* Aquí agregamos la clase 'hidden' para pantallas pequeñas y 'block' para grandes */}
          <form
            className="w-full sm:w-[350px] ml-auto"
